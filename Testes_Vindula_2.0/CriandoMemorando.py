...
class CriandoMemorando(unittest.TestCase):
    def setUp(self):
...
#        self.accept_next_alert = true
    ...
    def test_criando_memorando(self):
        driver = self.driver
	...
	print '-'*80
	print 'Adicionando aplicacao Memorando'
	print '-'*80	
        driver.find_element_by_css_selector("a[title=\"Adiciona novos itens dentro deste item\"] > span").click()
        driver.get(self.base_url + "/vindula/pasta-de-testes/portal_factory/Memorandos/memorandos.2013-04-11.0011778781/edit")
        driver.find_element_by_id("title").clear()
        driver.find_element_by_id("title").send_keys("Teste Memorandos")
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys("Teste")
        driver.find_element_by_id("head_one").clear()
        driver.find_element_by_id("head_one").send_keys("Teste")
        driver.find_element_by_id("head_two").clear()
        driver.find_element_by_id("head_two").send_keys("Teste")

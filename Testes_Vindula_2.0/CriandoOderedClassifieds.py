...
class CriandoOderedClassifieds(unittest.TestCase):
    def setUp(self):
...
#        self.accept_next_alert = true
    ...
    def test_criando_odered_classifieds(self):
        driver = self.driver
	...
	driver.find_element_by_id("__ac_name").clear()
        ...
        print '-'*80
	print 'Adcionando aplicacao OrderedClassifieds'
	print '-'*80	
        driver.find_element_by_css_selector("a[title=\"Adiciona novos itens dentro deste item\"]").click()
        driver.get(self.base_url + "/pasta-de-testes/portal_factory/OrderedClassifieds/orderedclassifieds.2013-04-11.9286974640/edit")
        driver.find_element_by_id("title").clear()
        driver.find_element_by_id("title").send_keys("Teste")
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys("OrderedClassifieds")

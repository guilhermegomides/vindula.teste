...
class CriandoColecao(unittest.TestCase):
    def setUp(self):
...
#        self.accept_next_alert = true
	...
	print '-'*80
	print 'Criando Conteudo Colecao'
	print '-'*80	
        driver.get(self.base_url + "/vindula/pasta-de-testes/portal_factory/Topic/topic.2013-04-11.4483050624/edit")
        driver.find_element_by_id("title").clear()
        driver.find_element_by_id("title").send_keys("Teste Colecao")

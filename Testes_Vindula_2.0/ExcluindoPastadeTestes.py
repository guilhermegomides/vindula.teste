...
class ExcluindoPastadeTestes(unittest.TestCase):
    def setUp(self):
...
#        self.accept_next_alert = true
    ...
    def test_excluindo_pastade_testes(self):
        driver = self.driver
	...
	print '-'*80
	print 'Excluindo Pasta de Teste'
	print '-'*80	
        driver.find_element_by_link_text("Conteúdo").click()
        driver.find_element_by_id("cb_pasta-de-testes").click()
        driver.find_element_by_name("folder_delete:method").click()

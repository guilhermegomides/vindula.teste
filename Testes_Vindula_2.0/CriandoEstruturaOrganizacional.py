...
class CriandoEstruturaOrganizacional(unittest.TestCase):
    def setUp(self):
...
#        self.accept_next_alert = true
    ...
    def test_criando_estrutura_organizacional(self):
        driver = self.driver
	...
	print '-'*80
	print 'Adicionando conteudo Estrutura Organizacional'
	print '-'*80
        driver.find_element_by_css_selector("a[title=\"Adiciona novos itens dentro deste item\"]").click()
        driver.get(self.base_url + "/vindula/pasta-de-testes/portal_factory/OrganizationalStructure/organizationalstructure.2013-04-12.9976833502/edit")
        driver.find_element_by_id("title").clear()
        driver.find_element_by_id("title").send_keys("Teste Estrutura Organizacional")
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys("Teste")
        driver.find_element_by_xpath("//input[@value='Adicione-me']").click()
        driver.find_element_by_xpath("(//input[@value='Adicione-me'])[2]").click()
        driver.find_element_by_css_selector("div.userandgroupselect > div > input.searchButton").click()
        driver.find_element_by_xpath("(//input[@value='Adicione-me'])[2]").click()
        driver.find_element_by_id("text").clear()
        driver.find_element_by_id("text").send_keys("Testando")
        driver.find_element_by_xpath("//input[@value='Adicione-me']").click()
        driver.find_element_by_name("form.button.save").click()
        print '-'*80
	print 'Alterando o estado do conteudo de privado para publico'
	print '-'*80	
